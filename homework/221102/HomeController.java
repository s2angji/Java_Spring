...
public class HomeController 
{
	...
	public String param( String myname, int myage, String mybirth, Model model) 
	{
		...
		model.addAttribute("image", "/image/a.jpg");
...
//		model.addAttribute("result", obesity);
	...
	public String pizzaOrder(String myname, String mytel, 
			String myemail, String color, String[] topping, 
		...
		model.addAttribute("myarr", topping);
