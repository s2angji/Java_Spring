...
public class HomeController 
{
	...
	public String insert(Model model) 
	{
		...
		return "insertView"; // forward: view a.jsp 
	}
	...
	public String select(Model model) 
	{
		...
		return "selectView"; // forward: view a.jsp 
	}
	...
	public String insertProduct(String pname, int pnum, String pdate, Model model) 
	{
		int n =pdaoImpl.insertProduct(new ProductDTO(pname,pnum,pdate));
		model.addAttribute("result","추가성공:"+n);
	...
	@RequestMapping(value = "/selectProductOr", method = RequestMethod.GET)
	public String selectProductOr(String pname, Model model) 
	{
		HashMap<String, Object> arg = new HashMap<String, Object>();
		arg.put("productname", pname);
		ArrayList<ProductDTO> arr = pdaoImpl.selectProductOr(arg);
		model.addAttribute("arr",arr);
